    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          color: "hsl(0,0%,50%)", textTransform: "uppercase",
        }}
      >
        SPECIMEN_REF: AA-2024 / BODY_ARCHIVE
      </motion.div>
      ...
      >
        <div style={{
          ...
          SURFACE_DEFORMATION_MODULE / MOVE CURSOR
        </div>
        <canvas
          ref={canvasRef}
      ...
      <motion.p
        ...
        style={{
          marginTop: "2rem",
          fontFamily: "'JetBrains Mono', monospace",
          fontSize: "0.6rem", color: "hsl(0,0%,50%)",
